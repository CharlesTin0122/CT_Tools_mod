...
CTRL_SL = [
    ...
    "thumb_L0_fk1_ctl",
    "thumb_L0_fk2_ctl",
    "index_metacarpal_L0_ctl",
    "index_L0_fk0_ctl",
    "index_L0_fk1_ctl",
    "index_L0_fk2_ctl",
    "middle_metacarpal_L0_ctl",
    "middle_L0_fk0_ctl",
    "middle_L0_fk1_ctl",
    "middle_L0_fk2_ctl",
    "ring_metacarpal_L0_ctl",
    "ring_L0_fk0_ctl",
    "ring_L0_fk1_ctl",
    "ring_L0_fk2_ctl",
    "pinky_metacarpal_L0_ctl",
    "pinky_L0_fk0_ctl",
    "pinky_L0_fk1_ctl",
    "pinky_L0_fk2_ctl",
    "clavicle_R0_ctl",
    ...
    "thumb_R0_fk1_ctl",
    "thumb_R0_fk2_ctl",
    "index_metacarpal_R0_ctl",
    "index_R0_fk0_ctl",
    "index_R0_fk1_ctl",
    "index_R0_fk2_ctl",
    "middle_metacarpal_R0_ctl",
    "middle_R0_fk0_ctl",
    "middle_R0_fk1_ctl",
    "middle_R0_fk2_ctl",
    "ring_metacarpal_R0_ctl",
    "ring_R0_fk0_ctl",
    "ring_R0_fk1_ctl",
    "ring_R0_fk2_ctl",
    "pinky_metacarpal_R0_ctl",
    "pinky_R0_fk0_ctl",
    "pinky_R0_fk1_ctl",
    "pinky_R0_fk2_ctl",
    "leg_L0_fk0_ctl",
...
class AdvAnimToolsUI:
    ...
    def import_and_save(self, *args):
        ...
        for fbxPath in self.fbxList:
            ...
            pm.currentUnit(time="ntsc")  # 设置帧率为30fps
            # 设置时间滑块范围并在第0帧设置关键帧
            pm.env.setMinTime(0)
            pm.env.setMaxTime(1)
            pm.currentTime(0)
